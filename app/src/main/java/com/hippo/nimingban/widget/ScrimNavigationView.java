...
public class ScrimNavigationView extends NavigationView implements DrawerLayoutChild {
    ...
    public ScrimNavigationView(Context context) {
        super(context);
        init();
    }

    public ScrimNavigationView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public ScrimNavigationView(Context context, AttributeSet attrs, int defStyleAttr) {
