...
public final class DB {
    ...
    private static String[] AC_FORUM_MSG_ARRAY = {
            ...
            "<p><img src=\"http://static.acfun.mm111.net/h/image/2014-8-26/7f36127a-e7dc-406e-bd1d-47dc489625ac.gif\" /><br />\n" +
                    ...
                    "&bull;本版发文间隔???秒</p>\n",
            // 买买买
            "<img title=\"买买买！不买还是人？赶紧剁手！\" src=\"http://hacfun-tv.n1.yun.tf:8999/Public/Upload/thumb/2015-11-02/56374260dac57.jpg\"" +
                    " height=132px width=200px style=\"float:left\" />•双十一剁手大赛开始啦，相关优惠信息、值得买的宝贝在此版集中交流<br />" +
                    "•本版原则：只分享好物，不做伸手党，装机求助请转<a href=\"/f/%E6%95%B0%E7%A0%81\">数码</a>版<br />" +
                    "•允许发商品链接，发链接时请附宝贝图，禁止商业推销和广告刷版",
            // 活动
            "•本版块为活动专用版块，机会多多，福利多多</br>•参加活动的串请遵守活动相关规则，格式错误将失去参与资格</br>•本版发文间隔为15秒。",
            // 动画
            ...
            "<p>&bull;DOTA和LOL版块拆分，相关讨论请移步专版，跨版引战一律锁IP<br />\n" +
                    ...
                    "&bull;本版发文间隔为15秒。</p>\n",
            // Steam
            "<img title=\"喜+1\" src=\"http://hacfun-tv.n1.yun.tf:8999/Public/Upload/image/2015-11-08/563f0b4a33200.gif\"" +
                    " height=132px width=200px style=\"float:left\" />•喜+1版，欢迎各位交流+1经验<br>" +
                    "•<a href=\"/f/DOTA\">Dota2</a>、<a href=\"/f/GTA5\">GTA5</a>请至专版讨论.",
            // 辐射
            "废土破烂回收处理中心",
            // GTA5
            "<p>&bull;来联机横行霸道吧！<br />\n" +
