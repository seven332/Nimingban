...
public class BingSearchActivity extends TranslucentActivity implements EasyRecyclerView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ToolbarActivityHelper.setContentView(this, R.layout.activity_bing_search);
