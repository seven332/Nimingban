...
class GallerySceneUiImpl(
    logic: GallerySceneLogic,
    inflater: LayoutInflater,
    container: ViewGroup
) : GroupUi(), GallerySceneUi {
...
inline fun gallerySceneUiImpl(
    logic: GallerySceneLogic,
    inflater: LayoutInflater,
    container: ViewGroup,
    init: GallerySceneUiImpl.() -> Unit
): GallerySceneUiImpl {
  val gallerySceneUiImpl = GallerySceneUiImpl(logic, inflater, container)
  gallerySceneUiImpl.init()
  return gallerySceneUiImpl
}
