...
class DefaultForumsUi(
  ...
  private inner class ForumHolder(itemView: View) : AbstractDraggableItemViewHolder(itemView) {
    ...
    init {
      ...
      val eye = StateListDrawable()
      eye.addState(context.loadDrawable(R.drawable.eye_primary_x24), android.R.attr.state_activated)
      eye.addState(context.loadDrawable(R.drawable.eye_off_primary_x24))
