...
class SortForumsPaper(
    private val logic: SortForumsLogic
) : NmbPaper<SortForumsUi>(logic), SortForumsUi {
  ...
  override fun onCreate(inflater: LayoutInflater, container: ViewGroup) {
    ...
    view = inflater.inflate(R.layout.paper_sort_forums, container, false)
  ...
  override fun updateForums(forums: MutableList<Forum>) {
    this.forums = forums
  ...
  private inner class ForumAdapter : RecyclerView.Adapter<ForumHolder>(), DraggableItemAdapter<ForumHolder> {
    ...
    override fun onMoveItem(fromPosition: Int, toPosition: Int) {
      ...
      // Update the forums
      logic.onReorderForum(fromPosition, toPosition)
    }
