 ...
 */
public class SmoothOverScroller {
     ...
     * @param context
     */
    public SmoothOverScroller(Context context) {
        this(context, null);
    }
     ...
     * be used.
     */
    public SmoothOverScroller(Context context, Interpolator interpolator) {
     ...
     */
    public SmoothOverScroller(Context context, Interpolator interpolator, boolean flywheel) {
    ...
    public boolean computeScrollOffset() {
        boolean resultX = mScrollerX.computeScrollOffset(mInterpolator);
        boolean resultY = mScrollerY.computeScrollOffset(mInterpolator);
    ...
    public boolean springBack(int startX, int startY, int minX, int maxX, int minY, int maxY) {
        mScrollerX.mMode = mScrollerY.mMode = FLING_MODE;
     ...
     *          already within the valid range.
     */
    public boolean springBackX(int start, int min, int max) {
     ...
     * @param min Minimum valid Y value
     * @param max Minimum valid Y value
     * @return true if a springback was initiated, false if startX and startY were
     *          already within the valid range.
     */
    public boolean springBackY(int start, int min, int max) {
        mScrollerY.mMode = FLING_MODE;
        return mScrollerY.springback(start, min, max);
    }
