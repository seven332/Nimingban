...
public class GalleryView extends GLView implements GestureRecognizer.Listener {
    ...
    private Mode mMode = Mode.LEFT_TO_RIGHT;
    ...
    public GalleryView(Context context, int firstShownIndex, ActionListener listener) {
        mBackgroundColor = ResourcesUtils.getAttrColor(context, android.R.attr.colorBackground);
    ...
    public void setShowEdgeView(boolean showEdgeView) {
        mShowEdgeView = showEdgeView;
    }
    ...
    private void fill() {
        ...
        if (mMode == Mode.NONE) {
            ...
            if (progressView == null) {
                progressView = new ProgressView(mBackgroundColor);
            }
