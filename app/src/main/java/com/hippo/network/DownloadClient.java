...
public class DownloadClient {
    ...
    private static long transferData(InputStream in, OutputStream out, long totalSize, OnDownloadListener listener)
            throws Exception {
        ...
        while (true) {
            ...
            if (listener != null) {
                listener.onDonwlad(receivedSize, bytesRead, totalSize);
            }
        }
    ...
    public static void execute(DownloadRequest request) {
        ...
        try {
            ...
            long receivedSize = transferData(httpResponse.getInputStream(), osPipe.open(), contentLength, listener);
    ...
    public interface OnDownloadListener {
        ...
        void onDonwlad(long receivedSize, long singleReceivedSize, long totalSize);
