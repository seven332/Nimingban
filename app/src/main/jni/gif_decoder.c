...
static inline jobject createObjFromGifFileType(JNIEnv* env, GifFileType* gifFile) {
    ...
    gifClazz = (*env)->FindClass(env, "com/hippo/gallery/GifDecoder");
...
jobject Java_com_hippo_gallery_GifDecoder_nativeDecodeStream
...
jboolean Java_com_hippo_gallery_GifDecoder_nativeRenderBitmap
...
void Java_com_hippo_gallery_GifDecoder_nativeRecycle
